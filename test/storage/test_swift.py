...
from libcloud.storage.drivers.swift import SwiftStorageDriver
...
class SwiftTests(unittest.TestCase):
    ...
    def setUp(self):
        SwiftStorageDriver.connectionCls.conn_classes = (
            None, SwiftMockHttp)
        SwiftStorageDriver.connectionCls.rawResponseCls = \
                                              SwiftMockRawResponse
        SwiftMockHttp.type = None
        SwiftMockRawResponse.type = None
        self.driver = SwiftStorageDriver('dummy', 'dummy')
    ...
    def test_invalid_json_throws_exception(self):
        SwiftMockHttp.type = 'MALFORMED_JSON'
        try:
    ...
    def test_create_container_already_exists(self):
        SwiftMockHttp.type = 'ALREADY_EXISTS'
    ...
    def test_download_object_invalid_file_size(self):
        SwiftMockRawResponse.type = 'INVALID_SIZE'
        container = Container(name='foo_bar_container', extra={}, driver=self)
        obj = Object(name='foo_bar_object', size=1000, hash=None, extra={},
                     container=container, meta_data=None,
                     driver=SwiftStorageDriver)
    ...
    def test_download_object_success_not_found(self):
        SwiftMockRawResponse.type = 'NOT_FOUND'
        container = Container(name='foo_bar_container', extra={}, driver=self)
    ...
    def test_upload_object_success(self):
        ...
        old_func = SwiftStorageDriver._upload_file
        SwiftStorageDriver._upload_file = upload_file
        ...
        SwiftStorageDriver._upload_file = old_func
    ...
    def test_upload_object_invalid_hash(self):
        ...
        SwiftMockRawResponse.type = 'INVALID_HASH'
    ...
    def test_upload_object_error(self):
        ...
        old_func2 = SwiftMockHttp.send
        SwiftMockHttp.send = send
...
class SwiftMockHttp(StorageMockHttp):

    fixtures = StorageFileFixtures('swift')
    base_headers = { 'content-type': 'application/json; charset=UTF-8'}

    # fake auth token response
    def _v1_0(self, method, url, body, headers):
        headers = copy.deepcopy(self.base_headers)
        headers.update({ 'x-auth-token': 'FE011C19',
...
class SwiftMockRawResponse(MockRawResponse):
