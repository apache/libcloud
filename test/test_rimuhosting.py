...
class RimuHostingTest(unittest.TestCase):
    ...
    def test_create_node(self):
        ...
        self.driver.create_node(node,"api.ivan.net.nz",image, size)

class RimuHostingMockHttp(MockHttp):
    def _r_orders(self,method,url,body,headers):
        body = """{ "get_orders_response" : { "status_message" : null , "status_code" : 200 , "error_info" : null , "response_type" : "OK" , "human_readable_message" : "Found 15 orders", "response_display_duration_type" : "REGULAR", "about_orders" :[
        { "order_oid" : 88833465
  ...
  , "pricing_plan_infos" : [{ "pricing_plan_code" : "MiroVPSLowContention"
        ...
        , "server_type" : "VPS"
        , "offered_at_data_center" : { "data_center_location_code" : "DCDALLAS"
  ...
  , "response_display_duration_type" : "REGULAR"
  , "setup_messages" : ["New order request received: { \"new_vps_request\" : { \"billing_oid\" : 96122465\n  , \"user_oid\" : 0\n  , \"host_server_oid\" : null\n  , \"vps_order_oid_to_clone\" : 0\n  , \"ip_request\" : null\n  , \"vps_parameters\" : null\n  , \"pricing_plan_code\" : \"MIRO1B\"\n  , \"instantiation_options\" : { \"control_panel\" : \"webmin\"\n      , \"domain_name\" : \"api.ivan.net.nz\"\n      , \"password\" : \"aruxauce27\"\n      , \"distro\" : \"lenny\"}}}\n"
    , "Using user-specified billing data: Wire Transfer"
    , "Selected user as the owner of the billing details: Ivan Meredith"
    , "No VPS paramters provided, using default values."]
  , "about_order" : { "order_oid" : 52255865
      , "domain_name" : "api.ivan.net.nz"
      ...
      , "allocated_ips" : { "primary_ip" : "74.50.57.80"
          , "secondary_ips" : []}
      , "running_state" : "RUNNING"}
  , "new_order_request" : { "billing_oid" : 96122465
      , "user_oid" : 0
      , "host_server_oid" : null
      , "vps_order_oid_to_clone" : 0
  ...
  , "running_vps_info" : { "pings_ok" : true
      ...
      , "next_backup_time" : { "ms_since_epoch": 1256446800000, "iso_format" : "2009-10-25T05:00:00Z", "users_tz_offset_ms" : 46800000}
      , "vps_uptime_s" : 31
      , "vps_cpu_time_s" : 6
      , "running_state" : "RUNNING"
      , "is_suspended" : false}}}
...
{ "delete_server_response" : { "status_message" : null
  ...
  , "response_display_duration_type" : "REGULAR"
  , "cancel_messages" : ["api.ivan.net.nz is being shut down."
