...
class SwiftRawResponse(SwiftResponse, RawResponse):
    pass

class SwiftConnection(OpenstackBaseConnection):
    """
    Base connection class for the Cloudfiles driver.
    """

    responseCls = SwiftResponse
    ...
    def request(self, action, params=None, data='', headers=None, method='GET', raw=False, host=None):
        ...
        return super(SwiftConnection, self).request(
            action=action,
