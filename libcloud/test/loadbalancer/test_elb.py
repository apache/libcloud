...
from libcloud.test.loadbalancer.mocks.elb import ElasticLBMockHttp
from libcloud.test.secrets import LB_ELB_PARAMS

from .test_loadbalancer import BaseLBTests


class ElasticLBTests(BaseLBTests):
    ...
    def test_balancer_attach_member(self):
        # FIXME: Consumers need to be able to tell i don't work!
        pass
