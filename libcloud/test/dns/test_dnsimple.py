...
class DNSimpleDNSTests(unittest.TestCase):
    ...
    def test_list_records_success(self):
        ...
        self.assertHasKeys(
            record1.extra, ["ttl", "created_at", "updated_at", "domain_id", "priority"]
        )
        ...
        self.assertHasKeys(
            record2.extra, ["ttl", "created_at", "updated_at", "domain_id", "priority"]
        )
        ...
        self.assertHasKeys(
            record3.extra, ["ttl", "created_at", "updated_at", "domain_id", "priority"]
        )
    ...
    def test_get_record_success(self):
        ...
        self.assertHasKeys(
            record.extra, ["ttl", "created_at", "updated_at", "domain_id", "priority"]
        )
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(
            name="domain4", zone=zone, type=RecordType.MX, data="mail.example.com"
        )
    ...
    def test_update_record_success(self):
        ...
        record1 = self.driver.update_record(
            record=record, name="www", type=record.type, data="updated.com", extra=extra
        )
        self.assertEqual(record.data, "example.com")
