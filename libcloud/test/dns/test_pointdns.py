...
class PointDNSTests(unittest.TestCase):
    ...
    def test_ex_list_mail_redirects(self):
        ...
        self.assertEqual(mail_redirect2.destination, "second.user@example-site.com")
    ...
    def test_ex_create_redirect(self):
        ...
        zone = self.driver.list_zones()[0]
        PointDNSMockHttp.type = "CREATE"
        redirect = self.driver.ex_create_redirect(
            "http://other.com", "redirect2", "302", zone, iframe="An Iframe", query=True
        )
