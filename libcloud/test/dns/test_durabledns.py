...
class DurableDNSTests(LibcloudTestCase):
    ...
    def test_get_zone(self):
        ...
        self.assertEqual(zone.extra["update_acl"], "127.0.0.1/32,127.0.0.100/32")
        self.assertEqual(len(zone.extra.keys()), 9)
    ...
    def test_get_record_zone_does_not_exist(self):
        DurableDNSMockHttp.type = "ZONE_DOES_NOT_EXIST"
        try:
            self.driver.get_record(zone_id="nonexistentzone.com.", record_id="record1")
    ...
    def test_create_zone_with_extra_param(self):
        ...
        zone = self.driver.create_zone(
            domain="myzone.com.",
            ttl=4000,
            extra={"mbox": "mail.myzone.com", "minimum": 50000},
        )
    ...
    def test_update_zone(self):
        ...
        self.assertEqual(updated_zone.extra["update_acl"], z_extra["update_acl"])
