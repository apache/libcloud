...
class LinodeTests(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = LinodeDNSDriver(*DNS_PARAMS_LINODE, **DNS_KEYWORD_PARAMS_LINODE)
    ...
    def test_list_records_success(self):
        ...
        self.assertHasKeys(arecord.extra, ["protocol", "ttl_sec", "port", "weight"])
    ...
    def test_update_zone_success(self):
        ...
        updated_zone = self.driver.update_zone(
            ...
            domain="libcloud.org",
            ttl=10,
            extra={"SOA_Email": "bar@libcloud.org"},
        )
