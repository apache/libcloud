...
from libcloud.common.osc import UNSIGNED_PAYLOAD
...
class OSCRequestSignerAlgorithmV4TestCase(LibcloudTestCase):
    ...
    def setUp(self):
        SignedOSCConnection.driver = EC2MockDriver()
        SignedOSCConnection.service_name = 'my_service'
        SignedOSCConnection.version = 'latest'
        self.connection = SignedOSCConnection('my_key', 'my_secret')

        self.signer = OSCRequestSignerAlgorithmV4(access_key='my_key',
                                                  access_secret='my_secret',
                                                  version='2013-10-15',
                                                  connection=self.connection)

        SignedOSCConnection.action = '/my_action/'
        SignedOSCConnection.driver = EC2MockDriver()
    ...
    def test_v4_signature(self):
        ...
        headers = {
            'Host': 'fcu.eu-west-1.amazonaws.com',
        ...
        sig = self.signer._get_authorization_v4_header(params=params,
                                                       ...
                                                       method='GET',
                                                       path='/my_action/')
        self.assertEqual(sig, 'OSC4-HMAC-SHA256 '
                              'Credential=my_key/20150304/my_region/my_service/osc4_request, '
                              'SignedHeaders=accept-encoding;host;user-agent;x-osc-date, '
                              'Signature=ae81e5ee4b4b153c1826c33c27a77e39e43e89832fc0afe31263f997944963e9')
    ...
    def test_v4_signature_contains_credential_scope(self):
        with mock.patch('libcloud.common.osc.OSCRequestSignerAlgorithmV4._get_credential_scope') as mock_get_creds:
    ...
    def test_v4_signature_contains_signed_headers(self):
        with mock.patch('libcloud.common.osc.OSCRequestSignerAlgorithmV4._get_signed_headers') as mock_get_headers:
    ...
    def test_v4_signature_contains_signature(self):
        with mock.patch('libcloud.common.osc.OSCRequestSignerAlgorithmV4._get_signature') as mock_get_signature:
    ...
    def test_get_signature_(self):
        ...
        with mock.patch('libcloud.common.osc.OSCRequestSignerAlgorithmV4._get_key_to_sign_with') as mock_get_key:
            with mock.patch('libcloud.common.osc.OSCRequestSignerAlgorithmV4._get_string_to_sign') as mock_get_string:
                with mock.patch('libcloud.common.osc._sign', new=_sign):
    ...
    def test_get_key_to_sign_with(self):
        ...
        self.assertEqual(key, 'OSC4my_secret|20150304|my_region|my_service|osc4_request')
    ...
    def test_get_credential_scope(self):
        ...
        self.assertEqual(scope, '20150304/my_region/my_service/osc4_request')
    ...
    def test_get_payload_hash_returns_digest_of_empty_string_for_GET_requests(self):
        SignedOSCConnection.method = 'GET'
    ...
    def test_get_payload_hash_with_data_for_PUT_requests(self):
        SignedOSCConnection.method = 'PUT'
    ...
    def test_get_payload_hash_with_empty_data_for_POST_requests(self):
        SignedOSCConnection.method = 'POST'
