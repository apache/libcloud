...
from libcloud.compute.base import (
    Node, NodeImage, NodeLocation, NodeDriver, NodeSize,
)
...
class RackspaceConnection(OpenStackBaseConnection):
    ...
    def __init__(self, user_id, key, secure, host=None, port=None):
        ...
        super(RackspaceConnection, self).__init__(user_id, key, secure=secure)
...
class RackspaceNodeDriver(NodeDriver):
    ...
    def _get_size_price(self, size_id):
        if 'rackspace' not in PRICING_DATA['compute']:
            return 0.0
