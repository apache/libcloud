...
class OutscaleSDKNodeDriver(NodeDriver):
    ...
    def get_outscale_endpoint(region, version, action):
        return "https://api.{}.outscale.com/{}/{}".format(region, version, action)

    def list_images(self, version='latest'):
        """
        List all images.
        ...
        authorization = OSCRequestSignerAlgorithmV4(access_key=self.key,
        ...
        endpoint = self.get_outscale_endpoint(self.region, version, 'ReadImages')
